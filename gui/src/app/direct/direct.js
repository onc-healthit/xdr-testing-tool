	...
	function($stateProvider) {
		$stateProvider.state('direct', {
			...
			templateUrl: 'message-validators/xdr-validator/xdr-validator.tpl.html'
				...
				}, data:{filterCrit: 'h2',pageTitle:' 170.315(h)(2)'}
			}).state('direct.help', {
				url: '/help',
				views: {
					"direct": {
            ...
            }).state('direct.certh2.description', {
				url: '/description/:id',
				views: {
					"certh2": {
			...
			.state('direct.certh2.xdrdescription', {
				url: '/xdrdescription/',
				params: {
					id: null,
					testObj: null
